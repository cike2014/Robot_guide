...
public class DataCenter {
    ...
    static {
        //初始化QuestionMap
        // 全身症状
        Question question=new Question("您有发热吗？", "1", "是的;是;有;偶尔;有时候;发热", "否;没有");
        questionMap.put(1, question);
        question=new Question("您感觉浑身没劲、出虚汗吗？", "3", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(3, question);
        question=new Question("您最近有没有食欲？", "5", "是的;是;有;吃的很多", "否;没有;没有食欲;吃的很少");
        questionMap.put(5, question);
        question=new Question("您最近皮肤或眼睛有明显发黄吗？", "6", "是的;是;有", "否;没有");
        questionMap.put(6, question);
        question=new Question("您最近有失眠吗？", "4", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(4, question);

        // 头部症状
        question=new Question("您头疼吗？", "11", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(11, question);
        question=new Question("您头晕吗？", "12", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(12, question);
        question=new Question("您最近有突然昏倒的情况吗？", "13", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(13, question);
        question=new Question("您的口唇最近有发青发紫的情况吗？", "10", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(10, question);
        question=new Question("您最近有抽搐或短暂昏迷吗？", "2", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(2, question);
        question=new Question("您有头面部水肿的现象吗？", "7", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(7, question);

        // 胸部症状
        question=new Question("您有胸疼吗？", "14", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(14, question);
        question=new Question("您最近感觉心慌吗？", "16", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(16, question);
        question=new Question("您最近感觉呼吸困难吗?", "15", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(15, question);
        question=new Question("您最近咳嗽吗？", "8", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(8, question);
        question=new Question("您咳嗽时有血丝或血块吗？", "9", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(9, question);
        question=new Question("您的皮肤有出血点或瘀斑吗？", "18", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(18, question);
        question=new Question("您胸部有硬结或肿块吗？", "20", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(20, question);

        // 腹部症状
        question=new Question("您肚子疼吗？", "23", "是的;是;有;偶尔;有时候;疼", "否;没有");
        questionMap.put(23, question);
        question=new Question("您拉肚子吗？", "24", "是的;是;有;偶尔;有时候;拉肚子", "否;没有");
        questionMap.put(24, question);
        question=new Question("您最近有感觉恶心或呕吐吗？", "17", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(17, question);
        question=new Question("您便秘吗？", "25", "是的;是;有;偶尔;有时候;便秘", "否;没有");
        questionMap.put(25, question);
        question=new Question("您最近大便时有血吗？或者大便呈黑褐色吗？", "22", "是的;是;有;偶尔;有时候;有血;", "否;没有");
        questionMap.put(22, question);
        question=new Question("您最近有呕血或吐血吗？", "19", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(19, question);
        question=new Question("您腹部有肿块吗？", "26", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(26, question);
        question=new Question("您最近有小便次数增多吗？", "33", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(33, question);
        question=new Question("您最近排尿时有尿急与疼痛现象吗？", "34", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(34, question);
        question=new Question("您最近的尿量多吗？", "36", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(36, question);
        question=new Question("您最近有尿少或无尿吗？", "35", "是的;是;有;偶尔;有时候", "否;没有");
        questionMap.put(35, question);

        //
        question=new Question("您最近腰背疼吗？", "21", "是的;是;有", "否;没有");
        questionMap.put(21, question);
        question=new Question("您有胳膊或腿疼吗？", "30", "是的;是;有", "否;没有");
        questionMap.put(30, question);
        question=new Question("您有关节疼吗？", "27", "是的;是;有", "否;没有");
        questionMap.put(27, question);
        question=new Question("您的胳膊、腿有肿胀现象吗？", "29", "是的;是;有", "否;没有");
        questionMap.put(29, question);
        question=new Question("您的胳膊、腿有肿块吗？", "31", "是的;是;有", "否;没有");
        questionMap.put(31, question);
        question=new Question("您的皮肤有出血点或紫点瘀斑吗？", "28", "是的;是;有", "否;没有");
        questionMap.put(28, question);
        question=new Question("您的胳膊或腿对冷、热、痛感觉变迟钝吗？", "32", "是的;是;有", "否;没有");
    ...
    public List<IntelligentGuideDepartment> guidingDepartment(String sids, Context context) {
        ...
        if (!TextUtils.isEmpty(sids)) {
            ...
            for (IntelligentGuideSymptoms symptoms : intelligentGuideSymptoms) {
                List<IntelligentGuideSymptomDepartment> symptomDepartments=intelligentGuideSymptomDepartmentDao.query("symptom_id", symptoms.id + "");
                if (intelligentGuideSymptomDepartments != null)
                    intelligentGuideSymptomDepartments.addAll(symptomDepartments);
            }
